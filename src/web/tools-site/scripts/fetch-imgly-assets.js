 ...
 * to pull down only the handful of files RemoveBgTool actually needs
 * (wasm runtime + the "small"/isnet_quint8 model — see RemoveBgTool.tsx for
...
// RemoveBgTool.tsx — only the resource keys actually requested at runtime
